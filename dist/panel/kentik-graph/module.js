...
System.register(['./graph', './legend', './series_overrides_ctrl', './thresholds_form', './template', 'moment', 'app/core/utils/kbn', 'lodash', 'app/core/time_series2', 'app/core/config', 'app/core/utils/file_export', './sdk/sdk'], function(exports_1) {
    var __extends = (this && this.__extends) || function (d, b) {
        for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        function __() { this.constructor = d; }
        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());
    };
    var template_1, moment_1, kbn_1, lodash_1, time_series2_1, config_1, fileExport, sdk_1;
    var GraphCtrl;
    return {
        setters:[
            function (_1) {},
        ...
        execute: function() {
            GraphCtrl = (function (_super) {
                ...
                function GraphCtrl($scope, $injector, annotationsSrv) {
                    ...
                    lodash_1.default.defaults(this.panel.alert, this.panelDefaults.alert);
