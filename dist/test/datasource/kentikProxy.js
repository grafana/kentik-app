...
function getHash(queryObj) {
  var query = _lodash2.default.cloneDeep(queryObj);
...
function getMaxRefreshInterval(query) {
  ...
  if (interval > _moment2.default.duration(1, 'months')) {
    return 60 * 60 * 1000; // 1 hour
  } else if (interval > _moment2.default.duration(1, 'day')) {
